...
class mediatorInventario @Inject constructor(
    private val dataFirebase: DataCloudImpl,
    private val  dbLocalInventario: QueryDBLocalInventarioImpl,
    ) {

    val subCollection = "inventario"

    suspend fun syncInventario(){
        val DataCloudInventario = dataFirebase.getAllInventarios(subCollection)
        val dataLocalInventarios = dbLocalInventario.datosInventoryRelations()
        println("Esto son los datos de las transacciones locales de Inventarios: $dataLocalInventarios <-- ")
        println("Esto son los datos de la db cloud de Inventarios: $DataCloudInventario <-- ")

        if (DataCloudInventario.isEmpty()) {
            println("Entre a la primera condicion")
            dataFirebase.insertInventarioTodataCloud(dataLocalInventarios,subCollection)
        }else if(dataLocalInventarios.isEmpty()){
            println("Entre a la segunda condicion")
           dbLocalInventario.insertInventoryRelations(DataCloudInventario)
        }else{
...
//                                mapInventario["id_inventario"] =
//                                    (inventario)["id_inventario"] as Long
...
//                                mapInventario["precio_compra"] =
//                                    (inventario)["precio_compra"] as Double
//                                mapInventario["precio_venta"] =
//                                    (inventario)["precio_venta"] as Double
//                            }
//                        }
//
//

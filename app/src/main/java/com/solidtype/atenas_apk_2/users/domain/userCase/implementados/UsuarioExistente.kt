...
class UsuarioExistente(private val repository:UserRepository=RepositoryImpl()) {

    suspend operator fun invoke(iccid:String):Boolean{
        return repository.usuarioExistente(iccid)
    }

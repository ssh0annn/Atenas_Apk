...
import com.solidtype.atenas_apk_2.authentication.data.remote.FirestoneConnect
...
class RepositoryImpl @Inject constructor(
    ...
    private val store: FirestoneConnect
) : UserRepository {
    override suspend fun signUp(
        ...
        if (auth.signinCorru(email, clave)) {//Debe ser un usuario existente en firebase.XY
    ...
    override suspend fun SignIn(email: String, clave: String) =
        auth.signinCorru(email, clave) // -> Boolean

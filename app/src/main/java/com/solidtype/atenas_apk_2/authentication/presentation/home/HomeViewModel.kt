package com.solidtype.atenas_apk_2.authentication.presentation.home
...
@HiltViewModel
class HomeViewModel @Inject constructor(private val casos_usos: AuthUseCases): ViewModel() {
